            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-md-8 col-xs-12">
                        <div class="white-box">
                            <form action='<c:url value="/users"/>' method="post" class="form-horizontal form-material" id="add-user-form">
                             		<c:forEach var ="item" items = "${listUserById}">
    								<div class="form-group">
                               			 <label class="col-md-12">Id user</label>
                                    <div class="col-md-12">
                                		<input class="form-control form-control-line" type="number" name="id" value ="${id}" disabled />
                                	</div>
                                    <label class="col-md-12">Full Name</label>
                                    <div class="col-md-12">
                                       <input type="text" name="fullname" value="${item.fullname}" placeholder="Enter fullname"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="email" placeholder="johnathan@admin.com"
                                            ...
                                            id="example-email" value="${item.email}"> </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12">Password</label>
                                    <div class="col-md-12">
                                        <input type="password" value="${item.password}" name="password" class="form-control form-control-line">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12">Phone No</label>
                                    <div class="col-md-12">
                                        <input type="text"value="${item.phone}" name="phone" placeholder="In number phone"
                                            class="form-control form-control-line"> </div>
                                </div>
                              </c:forEach>
                               <div class="form-group">
                                ...
                                <div class="form-group">
                                    <div class="col-sm-12">
                                        ...
                                        <button type="submit" name ="action" class="btn btn-success">Update user</button>
