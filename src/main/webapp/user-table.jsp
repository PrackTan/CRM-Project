        ...
        <nav class="navbar navbar-default navbar-static-top m-b-0">
                <div class="navbar-header"> 
                    ...
                    <div class="top-left-part">
                        <a class="logo" href="<c:url value="/users"/>">
                            <b>
            ...
            <div class="sidebar-nav navbar-collapse slimscrollsidebar">
                <ul class="nav" id="side-menu">
                    <li style="padding: 10px 0 0;">
                        <a href='<c:url value="/users"/>' class="waves-effect"><i class="fa fa-clock-o fa-fw"
                        ...
                        <div class="white-box">
                         ...
                         <c:forEach var="item" items="${listUserRole}">
                                        <tr>
											...
											<!--<<c:url value='/user-update'/>?id=${item.id}
											   	<form id="form-1" action="/users" method="post">
													<input type="hiden" value="${item.id}"/>
													<button href="#" class="btn btn-sm btn-danger">Xóa</button>
												</from> cách 1
												<a href="/users/${item.id}" class="btn btn-sm btn-danger">Xóa</a>
												cách 2-->
