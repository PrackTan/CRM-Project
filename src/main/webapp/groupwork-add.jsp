                        ...
                        <div class="white-box">
                            <form action="<c:url value='/groupwork-add'/>" method="post" class="form-horizontal form-material">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" name="group-name" placeholder="Tên công việc"
                                            class="form-control form-control-line"> </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12">Ngày bắt đầu</label>
                                    <div class="col-md-12">
                                        <input type="text" name="group-sdate" placeholder="yyyy-MM-dd"
                                            class="form-control form-control-line"> </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12">Ngày kết thúc</label>
                                    <div class="col-md-12">
                                        <input type="text"name="group-edate" placeholder="yyyy-MM-dd"
                                            class="form-control form-control-line"> </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-sm-12">
                                        <button type="submit" name ="" class="btn btn-success">Lưu lại</button>
