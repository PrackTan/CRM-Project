            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-md-8 col-xs-12">
                        <div class="white-box">
                            <form action="<c:url value='/user-add'/>" method="post" class="form-horizontal form-material" id="add-user-form">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" name="phone" placeholder="In number phone"
                                            class="form-control form-control-line"> </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-12">Select Role</label>
                                    <div class="col-sm-12">
                                        <select name="role" class="form-control form-control-line" placeholder="Nhập tên người dùng" title="Chọn một Vai trò">
                                            <c:forEach var="items" items="${listRole}">
                                ...
                                <div class="form-group">
                                    <div class="col-sm-12">
                                        <button type="submit" name="action" class="btn btn-success">Add User</button>
